 ...
 */
contract ERC721UpgradeSafe is Initializable, ContextUpgradeSafe, ERC165UpgradeSafe, IERC721UpgradeSafe, IERC721MetadataUpgradeSafe, IERC721Enumerable {
    ...
    // which can be also obtained as `IERC721ReceiverUpgradeSafe(0).onERC721Received.selector`
    ...
    EnumerableMapUpgradeSafe.UintToAddressMapUpgradeSafe private _tokenOwners;
    ...
    */
     ...
     * If the target address is a contract, it must implement {IERC721ReceiverUpgradeSafe-onERC721Received},
    ...
    /**
     * @dev Internal function to invoke {IERC721ReceiverUpgradeSafe-onERC721Received} on a target address.
